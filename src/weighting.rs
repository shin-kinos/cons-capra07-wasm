...
fn weight_henikoff( site_list : &Vec<String> /*, arg_t : &String */ ) -> Vec<f64> {
	...
	*/
	...
	/* Wasm : console.log() : Sum of weights. */
	let sum_weight_msg : String = "Sum of sequence weighting = ".to_string() + &format!( "{:.3}", sum_weight );
	console_log( &sum_weight_msg );
...
fn weight_va( seq_list : &Vec<String> ) -> Vec<f64> {
	...
	*/
	...
	/* Wasm : console.log() : Sum of weights. */
	let sum_weight_msg : String = "Sum of sequence weighting = ".to_string() + &format!( "{:.3}", sum_norm_weight );
	console_log( &sum_weight_msg );
