...
* @returns {string}
*/
export function calc_cons_capra07(file_input: string, opt_t: string, opt_w: string, opt_b: string): string;
...
export interface InitOutput {
  ...
  readonly calc_cons_capra07: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
